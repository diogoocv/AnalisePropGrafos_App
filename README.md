...
O exemplo acima executa as funções 0, 1, 2, 3, 4 e 5 (descritas abaixo), para um grafo com 4 vértices e 3 arestas, não direcionado, com as arestas (0,1), (0,2) e (2,3), todas com peso 1.
